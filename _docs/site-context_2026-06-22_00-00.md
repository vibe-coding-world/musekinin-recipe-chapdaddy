...
| `2026-06-19_02-40` | docs整理と_worklogs運用 |
| `2026-06-19_03-57` | 店長設定と材料表記統一 |
...
`fnm_multishells` の権限エラーが出る場合がある。

現状のファイル調査や単純なNode実行には影響していない。

`npm install` や `npm run` が失敗した場合に対応する。
